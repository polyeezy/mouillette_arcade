...
// Last update Tue Mar  8 14:26:45 2016 Valerian Polizzi
//
...
Launcher::Launcher()
{
  ...
  _gm.addTextToSurface("Help", 0, 30, "2: Prev lib 3: Next lib 4: Prev Game 5: Next Game 8: Restart Game 9: go back Esc: exit");
